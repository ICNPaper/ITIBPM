...
<p>
 ...
 fld_isu_cls_3[0] = "sw"; 
 %> 
 <input:select name="fld_isu_cls" defaults="<%=fld_isu_cls_3%>" optionLabels="<%=fld_isu_cls_1%>" optionValues="<%=fld_isu_cls_2%>" viewMode="0" attributes="<%=fld_isu_cls_0%>" multiple="false"  /> </p>
<p>
	Issue Note :
 <% 
