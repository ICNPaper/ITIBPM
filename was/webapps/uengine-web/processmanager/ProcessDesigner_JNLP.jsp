	...
	<jnlp spec="1.0+" codebase="<%=codebase%>"> 
	  ...
	  <security> 
	    ...
	    <j2se version="1.5+" initial-heap-size="500M" max-heap-size="1000M"/>
            ...
            <jar href="signedwsdl4j-1.6.1.jar"/>           
            <jar href="signedxml-apis-1.3.04.jar"/> 
            <jar href="signedxerces-j_1.4.0.jar"/>             
            <jar href="signeddom4j-1.6.1.jar"/> 
            <jar href="signedjdom-1.1.jar"/> 
            <jar href="signedtwister-engine-0.1.jar"/> 
            <jar href="signedbpel.jar"/>
            <jar href="signedtinylaf_.jar"/> 
            ...
            <jar href="signedxpp3_min-1.1.4c.jar"/> 
            <jar href="signedxstream-1.3.1.jar"/>
            <jar href="signeddrools-core.jar"/>
            <jar href="signedjanino-2.4.3.jar"/>
            <jar href="signedservlet.jar"/>
            <jar href="signedxml-apis-ext-1.3.04.jar"/>
