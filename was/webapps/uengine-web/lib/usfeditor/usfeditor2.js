SimpleEditor = function(config) {
	this.id = "";
	//button tag
	var _EDIT_BTN_TAG = "<img src='images/page_edit.png' />";
	var _DONE_BTN_TAG = "<img src='images/accept.png' />";
	var _ADD_BTN_TAG = "<img src='images/add.png' />";
	var _DEL_BTN_TAG = "<img src='images/cross.png' />";
	var _ADD_GROUP_BTN_TAG = "+ addGroup";
	var _DEL_GROUP_BTN_TAG = "- removeGroup";
	var _LEFT_INDENT_BTN_TAG = "<img src='images/shape_align_left.png' />";
	var _RIGHT_INDENT_BTN_TAG = "<img src='images/shape_align_right.png' />";
	var _ITEM_ADD_BTN_TAG = "<img src='images/add.png' />";
	var _ITEM_DEL_BTN_TAG = "<img src='images/cross.png' />";
	//title button tag
	var _BOLD_BTN_TAG = "<img src='images/text_bold.png' />";
	var _ITALIC_BTN_TAG = "<img src='images/text_italic.png' />";
	var _UNDERLINE_BTN_TAG = "<img src='images/text_underline.png' />"
	var _CANCELLINE_BTN_TAG = "<img src='images/cancel.png' />";
	//group title
	...
	if (config) {
		if (config.editBtn) _EDIT_BTN_TAG = config.editBtn;
		if (config.doneBtn) _DONE_BTN_TAG = config.doneBtn;
		if (config.addBtn) _ADD_BTN_TAG = config.addBtn;
		if (config.delGroupBtn) _DEL_GROUP_BTN_TAG = config.delGroupBtn;
		if (config.addGroupBtn) _ADD_GROUP_BTN_TAG = config.addGroupBtn;
		if (config.delBtn) _DEL_BTN_TAG = config.delBtn;
		if (config.leftIndentBtn) _LEFT_INDENT_BTN_TAG = config.leftIndentBtn;
		if (config.rightIndentBtn) _RIGHT_INDENT_BTN_TAG = config.rightIndentBtn;
		if (config.itemAddBtn) _ITEM_ADD_BTN_TAG = config.itemAddBtn;
		if (config.itemDelBtn) _ITEM_DEL_BTN_TAG = config.itemDelBtn;
		if (config.boldBtn) _BOLD_BTN_TAG = config.boldBtn;
		if (config.italicBtn) _ITALIC_BTN_TAG = config.italicBtn;
		if (config.underlineBtn) _UNDERLINE_BTN_TAG = config.underlineBtn;
		if (config.cancellineBtn) _CANCELLINE_BTN_TAG = config.cancellineBtn;
...
SimpleEditor.prototype = {
	...
	getViewModeContents : function () {
		...
		return $(contentsObject).html().replace("<?xml:namespace prefix = input />", "");
	},
