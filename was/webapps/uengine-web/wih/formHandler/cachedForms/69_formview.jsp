...
<DIV id=titleArea>
<DIV id=viewTitleArea><SPAN style="FONT-WEIGHT: normal">cc</SPAN></DIV></DIV>
<DIV id=fieldArea>
<DIV id=viewFieldArea>
<DIV id=rowViewFieldArea> <input:finduser name="cc" multiple="true" viewmode="<%=InputConstants.VIEW%>" ></input:finduser></DIV></DIV></DIV></LI></UL>
