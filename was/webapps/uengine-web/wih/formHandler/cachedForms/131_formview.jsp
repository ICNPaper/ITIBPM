...
<DIV id=titleArea>
<DIV id=viewTitleArea><SPAN style="FONT-WEIGHT: normal">map</SPAN></DIV></DIV>
<DIV id=fieldArea>
<DIV id=viewFieldArea>
<DIV id=rowViewFieldArea> <input:googlemap name="test" viewmode="<%=InputConstants.VIEW%>"  ="null"></input:googlemap></DIV></DIV></DIV></LI></UL>
