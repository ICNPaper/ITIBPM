...
<DIV id=rowViewFieldArea> <input:googlemap name="map" viewmode="<%=InputConstants.VIEW%>" ></input:googlemap></DIV></DIV></DIV></LI>
...
<DIV id=rowViewFieldArea>
 ...
 %> 
 <input:text name="c" attributes="<%=c_0%>" default="" viewMode="<%=InputConstants.VIEW%>" /></DIV></DIV></DIV></LI>
...
<DIV style="DISPLAY: block" id=fieldArea>
<DIV style="DISPLAY: block" id=viewFieldArea>
<DIV id=rowViewFieldArea> <input:fileupload name="file" viewmode="<%=InputConstants.VIEW%>"  fileclass="general"></input:fileupload></DIV></DIV></DIV></LI></UL>
